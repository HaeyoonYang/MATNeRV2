...
Don't divide the last two block into two branches (Luma / Chroma)
...
class NeRVDecoder(nn.Module):
    ...
    def __init__(self, logger, input_size, input_channels, output_size, output_channels,
        ...
        _head_cfg = cfg_override(head_cfg, C1=C2, C2=self.output_channels, Ch=max(C2, self.output_channels), kernel_size=1, act='none')
